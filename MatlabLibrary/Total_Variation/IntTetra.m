function [X,Y,Z,W]=IntTetra(N,vert)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% IntTetra.m - Gaussian Quadrature for a tetrahedron
%
% Calculate the integration over a tetrahetron domain given by vert
%
